    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-12">
            No more excuses. No more procrastination. Just proven results through structured learning 
            and real human connection.
          </p>
          
          <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-2xl p-8 border border-white border-opacity-20 max-w-2xl mx-auto">
            <p className="text-lg font-semibold mb-4 text-gray-900">
              Why thousands choose this challenge?
            </p>
            <p className="text-gray-700">
              You get a battle-tested workbook that adapts to your level, plus a vibrant community 
              where you practice daily with real people who become your accountability partners.
            </p>
          </div>
          <a href="#pricing" className="inline-block mt-10 bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-bold py-4 px-10 rounded-lg text-lg shadow-lg transition-all transform hover:scale-105">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <h2 className="text-4xl font-bold text-red-600 mb-4">YOU&apos;RE PRACTICING ALONE</h2>
            
            <div className="bg-red-50 p-6 rounded-lg">
              <h4 className="text-xl font-bold text-red-900 mb-2">Why 95% of learners fail</h4>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-blue-900 mb-4">YOUR PERSONALIZED SUCCESS ROADMAP</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl">
            <h3 className="text-2xl font-bold mb-4">Sarah from Brazil - 6 Months In</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Workbook Card */}
            <div className="bg-white p-8 rounded-2xl shadow-xl flex flex-col items-center text-center border border-gray-100 relative">
              <div className="mb-4 flex items-center justify-center w-14 h-14 rounded-full bg-blue-100">
              ...
              <ul className="space-y-2 text-gray-700 text-left mx-auto max-w-xs">
            ...
            {/* Community Card */}
            <div className="bg-white p-8 rounded-2xl shadow-xl flex flex-col items-center text-center border border-gray-100 relative">
              <div className="mb-4 flex items-center justify-center w-14 h-14 rounded-full bg-purple-100">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg">
              <div className="text-center space-y-4">
                ...
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-lg transition-colors text-lg transform hover:scale-105">
                  Start My Journey - $9
                </button>
              </div>
            </div>
            {/* Community Plan */}
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 text-white rounded-2xl p-8 shadow-xl relative flex flex-col">
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 z-10">
                <span className="bg-yellow-400 text-gray-900 px-5 py-2 rounded-full text-sm font-bold shadow-lg border-2 border-white">MOST POPULAR</span>
              </div>
              <div className="text-center space-y-4 mt-8">
                ...
                <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-4 px-6 rounded-lg transition-colors text-lg transform hover:scale-105">
      ...
      {/* Simple Footer */}
      <footer className="bg-gradient-to-r from-blue-900 via-blue-800 to-purple-900 text-white pt-12 pb-6 mt-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex flex-col items-center justify-center mb-6">
            ...
            <span className="text-2xl font-extrabold tracking-tight">Afrin English Challenge</span>
          </div>
